      ...
      <div className="contentSec">
        ...
        <div className="contentWrap">
          ...
          <div className="section">
            ...
            <h2 className={"tleft"}>What we collect</h2>
            ...
            <ul>
              ...
              <li>
                <span className={"Gen small ju"}>Name and contact details</span>
              </li>
          ...
          <div className="section">
            ...
            <ul>
              ...
              <li><span className={"Gen small ju"}>
                To perform compliance checks and keep/maintain internal
                records</span>
              </li>

              <li><span className={"Gen small ju"}>
                To use the information to improve our products and services</span>
              </li>
          ...
          <div className="section">
            ...
            <h2 className={"tleft"}>Security</h2>
          ...
          <div className="section">
            ...
            <h2 className={"tleft"}>Links to other websites</h2>
          ...
          <div className="section">
            ...
            <h2 className={"tleft"}>Controlling your personal information</h2>
          ...
          <div className="section">
            ...
            <h2 className={"tleft"}>Security certificates</h2>
